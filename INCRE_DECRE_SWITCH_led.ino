...
#define LOW_SWITCH 10
#define HIGH_SWITCH 11

int i = 0;
int low_switch_status,high_switch_status;
void setup() {
...
void loop() {
  ...
  // put your main code here, to run repeatedly:
    ...
    display(i);
    low_switch_status = digitalRead(LOW_SWITCH);
    high_switch_status = digitalRead(HIGH_SWITCH);
    if(low_switch_status ==0)
    {
      i--;
      delay(250);
    }
    else if(high_switch_status==0)
    {
      i++;
      delay(250);
    }
